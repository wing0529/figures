# -*- coding: utf-8 -*-
"""
Energy saving vs. baseline (%) — Large accelerator scale.
...
total   = {'fp16': np.array([16.05, 16.16, 16.35]),
           'bf16': np.array([-0.37,  9.88, 16.35]),
           'fp8':  np.array([ 9.84,  9.88, 16.35])}

refresh = {'fp16': np.array([66.97, 66.98, 66.53]),
...
fig.savefig('outputs/energy_saving_large.pdf', bbox_inches='tight')
plt.close(fig)

print('Saved outputs/energy_saving_large.pdf')
